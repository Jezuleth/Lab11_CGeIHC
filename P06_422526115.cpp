...
//Declaramos el nombre de los modelos
Model carro;
Model capo_carro;
Model rueda_derA;
Model rueda_derF;
...
int main()
{
	...
	//Dado 8 caras
	dado_8_caras = Texture("Textures/dado_8_caras.png");
	...
	while (!mainWindow.getShouldClose())
	{
		...
		model = glm::rotate(model, glm::radians(45.0f), glm::vec3(1.0f, 1.0f, 0.0f)); // Rotación más diagonal
		model = glm::scale(model, glm::vec3(3.0f, 3.0f, 3.0f)); 
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		dado_8_caras.UseTexture(); // CAMBIAMOS POR NUESTRA TEXTURA
		...
		*/
		...
		//Dado
		// Definición de vértices del octaedro con posiciones y coordenadas UV
		float vertices[] = {
			//   X     Y     Z    U    V  
			 0.0f,  1.0f,  0.0f, 0.5f, 1.0f,  // Vértice superior
			 1.0f,  0.0f,  1.0f, 0.25f, 0.75f, // V1
			-1.0f,  0.0f,  1.0f, 0.75f, 0.75f, // V2
			-1.0f,  0.0f, -1.0f, 0.75f, 0.25f, // V3
			 1.0f,  0.0f, -1.0f, 0.25f, 0.25f, // V4
			 0.0f, -1.0f,  0.0f, 0.5f, 0.0f    // Vértice inferior
		};

		// Índices para las caras triangulares del octaedro
		unsigned int indices[] = {
			0, 1, 2,  // Cara 1
			0, 2, 3,  // Cara 2
			0, 3, 4,  // Cara 3
		...
		// Para renderizar en el bucle de dibujo
		glBindVertexArray(VAO);
